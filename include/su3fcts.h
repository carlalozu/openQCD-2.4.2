...
// SoA operations
#pragma omp declare target
static inline void fsu3matxsu3vec(const su3_mat_field *u, const su3_vec_field *v, su3_vector_dble *res, int ip0, int ip1)
{
   res->c1.re = u->c1.c1re[ip0] * v->c1re[ip1] - u->c1.c1im[ip0] * v->c1im[ip1] +
...
#else
#pragma omp declare target
extern void fsu3matxsu3mat(const su3_mat_field *u, su3_dble *res, int ip0, int ip1);
extern void fsu3matdagxsu3matdag(const su3_mat_field *u, su3_dble *res, int ip2, int ip3);
extern void fsu3matxsu3vec(const su3_mat_field *u, const su3_vec_field *v, su3_vector_dble *res, int ip0, int ip1);
