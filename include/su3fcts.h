...
#ifndef SU3PRODV_C
#pragma omp declare target
static inline void fsu3matxsu3mat(const su3_mat_field *u, su3_dble *res, int ip0, int ip1)
{
...
static inline void fsu3matdagxsu3matdag(const su3_mat_field *u, su3_dble *res, int ip2, int ip3)
{
